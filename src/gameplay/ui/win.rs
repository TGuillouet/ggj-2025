...
pub fn spawn_menu(mut commands: Commands, assets_server: Res<AssetServer>) {
    commands
        ...
        .with_children(|children| {
            children.spawn((
                Text::new("Vous avez réussi à vous échapper !"),
                TextFont {
            ...
            children.spawn((
                Text::new("Appuyez sur une touche pour retourner au menu principal"),
                TextFont {
                    // This font is loaded and will be used instead of the default font.
                    font: assets_server.load("VT323-Regular.ttf"),
                    font_size: 30.0,
...
pub fn despawn_menu(mut commands: Commands, menu_query: Query<Entity, With<WinMenu>>) {
